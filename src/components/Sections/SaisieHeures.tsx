...
export const SaisieHeures: React.FC = () => {
  ...
  const handleSave = async (formData: FormData) => {
    ...
    const heuresTotal = calculateHoursWithLunchBreak(heureDebut, heureFin, heureTable);
    ...
    <form onSubmit={(e) => {
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Heure de table (pause déjeuner)</label>
            <input
              name="heureTable"
              type="time"
        ...
        <div className="bg-blue-50 p-4 rounded-lg">
          ...
          <div className="flex items-center">
            ...
            <p className="text-sm text-blue-600">
              Les heures sont calculées automatiquement en tenant compte de la pause déjeuner.
            </p>
          </div>
        </div>
      </div>
                  ...
                  <tr key={saisie.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-xs text-gray-500 mt-1">
                        ...
                        {saisie.heureTable && <span className="ml-1">(Pause: {saisie.heureTable})</span>}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
