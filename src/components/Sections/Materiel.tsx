...
import { Plus, Edit, Trash2, Wrench, Calendar, Download, Euro, Clock, TrendingUp, Calculator, PenTool as Tool, Search, Filter, Eye, AlertTriangle, CheckCircle, PenTool as Tool, Truck, MapPin, BarChart3, Percent } from 'lucide-react't { useRealtimeSupabase } from '../../hooks/useRealtimeSupabase';
