/*
  # Simplification du système d'heures - Passage aux heures totales

  1. Modifications
    - Suppression de la distinction entre heures normales, supplémentaires et exceptionnelles
    - Ajout d'une colonne heures_total pour stocker le total des heures
  ...
  2. Avantages
    ...
    - Facilité de saisie et de calcul
