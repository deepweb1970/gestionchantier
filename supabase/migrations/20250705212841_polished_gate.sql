/*
  # Update chantier hours calculation

  1. New Features
    - Add trigger to automatically update chantier avancement based on hours worked
    - Calculate progress based on labor cost vs. estimated budget
    - Maintain real-time synchronization between saisies_heures and chantiers
